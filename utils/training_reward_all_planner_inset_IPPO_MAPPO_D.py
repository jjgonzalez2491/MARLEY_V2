...
SEEDS = {
    'Seed 1': [12, 83],   # [IPPO key, MAPPO key]
    'Seed 2': [76, 84],
    'Seed 3': [77, 85],
}
...
ROW_YLIMS = [
    ...
    (-4, 0.18),     # row 2 — Entrant Reward
]

INSET_YLIMS = [
    (-0.307, -0.29),    # row 0 — Planner Reward
    (0.75, 0.95),       # row 1 — Incumbent Reward
    (0.025, 0.125),     # row 2 — Entrant Reward
]
...
if __name__ == '__main__':
    make_figure(output_path='training_reward_all_planner_inset_IPPO_MAPPO_D.pdf')
    print('Done.')